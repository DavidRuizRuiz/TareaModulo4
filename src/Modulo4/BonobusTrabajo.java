...
public class BonobusTrabajo extends JFrame {
    ...
    public BonobusTrabajo() {
        ...
        panelPrincipal.setBackground(new Color(89, 180, 187));
        ...
        panelCentral.setBounds(912, 49, 457, 518);
        panelCentral.setBackground(new Color(158, 189, 190));
        ...
        panelInferior.setBounds(20, 577, 1349, 50);
        panelInferior.setBackground(new Color(158, 189, 190));
        ...
        lblNewLabel.setBounds(20, 49, 882, 518);
        lblNewLabel.setIcon(new ImageIcon(BonobusTrabajo.class.getResource("/Imagenes/catedral-tour.jpg")));
